...
- [Creating and Deleting Directories with Python](http://stackabuse.com/creating-and-deleting-directories-with-python/)
...
- [TalkPython['Podcast']](https://talkpython.fm/) <span class="label">podcast</span>
